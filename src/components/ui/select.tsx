...
const Positioner = SelectPrimitive.Positioner as any
const Popup = SelectPrimitive.Popup as any
const List = SelectPrimitive.List as any
const GroupLabel = SelectPrimitive.GroupLabel as any
...
const ScrollUpArrow = SelectPrimitive.ScrollUpArrow as any
const ScrollDownArrow = SelectPrimitive.ScrollDownArrow as any
...
function SelectItem({
  ...
  return (
    <Item
      ...
      {...props}
    >
      <ItemText className="flex flex-1 shrink-0 gap-2 whitespace-nowrap">
        {children}
      </ItemText>
      <ItemIndicator
        render={
