...
import { KeyRound, ArrowRight, RefreshCw, Shield, CheckCircle, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-50/80 to-indigo-50/80 dark:from-blue-950/30 dark:to-indigo-950/30 border-2 border-blue-200 dark:border-blue-800/50 rounded-2xl p-6 space-y-4 transition-all duration-300">
      ...
      <div className="flex items-center gap-3 relative z-10">
        <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-xl" style={{ backgroundColor: "var(--blue-text-color)", color: "white" }}>
      ...
      <Button
        onClick={onVerify}
        className="w-full text-white font-semibold cursor-pointer py-5 text-base transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] relative z-10"
        style={{ background: 'var(--blue-btn)', borderRadius: "4px" }}
        disabled={loginOtpInput.length !== 4}
      >
